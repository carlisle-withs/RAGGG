...
## 问题：No static resource api/raggg/knowledge-base
...
#### 1. 确认后端服务运行
```bash
curl http://localhost:8080/api/raggg/knowledge-base
...
| 前端请求 | 代理后 | 后端实际路径 |
|---------|--------|-------------|
| /api/raggg/knowledge-base | http://localhost:8080/api/raggg/knowledge-base | /knowledge-base (context-path已包含/api/raggg) |
...
**正常情况：**
- Request URL: http://localhost:5173/api/raggg/knowledge-base
