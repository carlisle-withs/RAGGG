...
- **📌 时效说明（同日更新）**：本文为 2026-09-24 的范式分析。文中引用的部分工程缺陷**当日已完成修复**（SWA metadata 断链已打通且 Auto-Merging 生效、`permitAll` 已收紧为强制认证、ReAct 遗留清零），演进路线 1（修 SWA）与路线 3 的词映射部分已执行——**范式层面的对比分析与结论不受影响**，工程现状以 [known-gaps](./实现差距清单.md) 为准。
...
- [检索评测-PubMedQA-2026-09-21.md](./testing/检索评测-PubMedQA-2026-09-21.md) — PubMedQA 召回数据、rerank 静默失效发现
- [CRUD-RAG中文基准-2026-09-22.md](./testing/CRUD-RAG中文基准-2026-09-22.md) — CRUD-RAG 中文基准数据
- [RAGAS评测-2026-09-22.md](./testing/RAGAS评测-2026-09-22.md) — RAGAS 四指标、生成 p50 60s
- [Kafka流水线吞吐报告-2026-09-21.md](./testing/Kafka流水线吞吐报告-2026-09-21.md) — 摄入吞吐与瓶颈下钻
