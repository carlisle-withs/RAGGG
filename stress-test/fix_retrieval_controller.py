content = r'''package com.rag.api.rest.retrieval;
...
'''
with open(r'D:\Workspace\RAGGG\src\main\java\com\rag\api\rest\retrieval\RetrievalController.java', 'w', encoding='utf-8') as f:
    f.write(content)
print("Done")
